...
The UI uses a dark **scientific terminal** identity: a chronological river of positions
with monospace controls, day separators and infinite scroll, a left rail of filter chips
